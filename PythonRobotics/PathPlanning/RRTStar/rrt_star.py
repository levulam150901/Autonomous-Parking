...
class RRTStar(RRT):
    ...
    def choose_parent(self, new_node, near_inds):
        ...
        for i in near_inds:
            ...
            if t_node and self.check_collision(self,
                    t_node, self.obstacle_list, self.robot_width, self.robot_length):
    ...
    def rewire(self, new_node, near_inds):
        ...
        for i in near_inds:
            ...
            no_collision = self.check_collision(self,
                edge_node, self.obstacle_list, self.robot_width, self.robot_length)
...
def main():
    ...
    obstacle_list = [
        (5, 5, 1, 1),  # Rectangle obstacle
        (3, 6, 2, 1),  # Rectangle obstacle
        (3, 8, 2, 1),  # Rectangle obstacle
        (3, 10, 2, 1),  # Rectangle obstacle
        (7, 5, 2, 1),  # Rectangle obstacle
        (9, 5, 2, 1),  # Rectangle obstacle
        (8, 10, 1, 1),  # Rectangle obstacle
        (6, 12, 1, 1)  # Rectangle obstacle
    ]  # [x,y,size(radius)]
